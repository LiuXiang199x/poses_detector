...
(cl:defmethod cl:initialize-instance :after ((m <KeyValuePair>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyValuePair)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs-msg:<KeyValuePair> is deprecated: use common_msgs-msg:KeyValuePair instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KeyValuePair>)))
  ...
  (cl:format cl:nil "#use standard header~%#Header header~%~%#string values for key and its value~%string key~%string value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KeyValuePair)))
  "Returns full string definition for message of type 'KeyValuePair"
  (cl:format cl:nil "#use standard header~%#Header header~%~%#string values for key and its value~%string key~%string value~%~%~%"))
