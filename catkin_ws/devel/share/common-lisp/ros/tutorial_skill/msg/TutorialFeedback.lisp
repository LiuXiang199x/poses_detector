...
(cl:defclass <TutorialFeedback> (roslisp-msg-protocol:ros-message)
  ((app_status
    :reader app_status
    :initarg :app_status
    :type cl:string
...
(cl:defclass TutorialFeedback (<TutorialFeedback>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <TutorialFeedback>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'TutorialFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_skill-msg:<TutorialFeedback> is deprecated: use tutorial_skill-msg:TutorialFeedback instead.")))

(cl:ensure-generic-function 'app_status-val :lambda-list '(m))
(cl:defmethod app_status-val ((m <TutorialFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_skill-msg:app_status-val is deprecated.  Use tutorial_skill-msg:app_status instead.")
  (app_status m))

(cl:ensure-generic-function 'percentage_completed-val :lambda-list '(m))
(cl:defmethod percentage_completed-val ((m <TutorialFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_skill-msg:percentage_completed-val is deprecated.  Use tutorial_skill-msg:percentage_completed instead.")
  (percentage_completed m))

(cl:ensure-generic-function 'engagement-val :lambda-list '(m))
(cl:defmethod engagement-val ((m <TutorialFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_skill-msg:engagement-val is deprecated.  Use tutorial_skill-msg:engagement instead.")
  (engagement m))

(cl:ensure-generic-function 'response_params-val :lambda-list '(m))
(cl:defmethod response_params-val ((m <TutorialFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_skill-msg:response_params-val is deprecated.  Use tutorial_skill-msg:response_params instead.")
  (response_params m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TutorialFeedback>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TutorialFeedback>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TutorialFeedback>)))
  "Returns string type for a message object of type '<TutorialFeedback>"
  "tutorial_skill/TutorialFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TutorialFeedback)))
  "Returns string type for a message object of type 'TutorialFeedback"
  "tutorial_skill/TutorialFeedback")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TutorialFeedback>)))
  "Returns md5sum for a message object of type '<TutorialFeedback>"
  "dd2a3b825f95b7d9c1ba587b6f0eb46f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TutorialFeedback)))
  "Returns md5sum for a message object of type 'TutorialFeedback"
  "dd2a3b825f95b7d9c1ba587b6f0eb46f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TutorialFeedback>)))
  "Returns full string definition for message of type '<TutorialFeedback>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TutorialFeedback)))
  "Returns full string definition for message of type 'TutorialFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%string app_status~%uint8 percentage_completed~%bool engagement~%common_msgs/KeyValuePair[] response_params~%~%~%================================================================================~%MSG: common_msgs/KeyValuePair~%#use standard header~%#Header header~%~%#string values for key and its value~%string key~%string value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <TutorialFeedback>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TutorialFeedback>))
  "Converts a ROS message object to a list"
  (cl:list 'TutorialFeedback
