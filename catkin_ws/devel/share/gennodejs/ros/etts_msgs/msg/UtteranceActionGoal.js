...
let UtteranceGoal = require('./UtteranceGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class UtteranceActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = UtteranceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += UtteranceGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UtteranceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = UtteranceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new UtteranceGoal()
    }
...
module.exports = UtteranceActionGoal;
