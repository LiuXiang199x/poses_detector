...
let UtteranceFeedback = require('./UtteranceFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class UtteranceActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new UtteranceFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = UtteranceFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UtteranceActionFeedback(null);
    ...
    data.feedback = UtteranceFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UtteranceActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = UtteranceFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new UtteranceFeedback()
    }
...
module.exports = UtteranceActionFeedback;
