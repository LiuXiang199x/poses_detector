...
class KeyValuePairArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new KeyValuePairArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.array[i] = KeyValuePair.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new KeyValuePairArray(null);
    ...
    if (msg.array !== undefined) {
      ...
      for (let i = 0; i < resolved.array.length; ++i) {
        resolved.array[i] = KeyValuePair.Resolve(msg.array[i]);
      }
    }
    else {
      resolved.array = []
...
module.exports = KeyValuePairArray;
