...
let TutorialFeedback = require('./TutorialFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class TutorialActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TutorialFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TutorialFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TutorialActionFeedback(null);
    ...
    data.feedback = TutorialFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TutorialFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TutorialActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TutorialFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TutorialFeedback()
    }
...
module.exports = TutorialActionFeedback;
