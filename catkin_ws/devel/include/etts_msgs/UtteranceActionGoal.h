// Generated by gencpp from file etts_msgs/UtteranceActionGoal.msg
// DO NOT EDIT!


#ifndef ETTS_MSGS_MESSAGE_UTTERANCEACTIONGOAL_H
#define ETTS_MSGS_MESSAGE_UTTERANCEACTIONGOAL_H
...
#include <etts_msgs/UtteranceGoal.h>

namespace etts_msgs
{
template <class ContainerAllocator>
struct UtteranceActionGoal_
{
  typedef UtteranceActionGoal_<ContainerAllocator> Type;

  UtteranceActionGoal_()
    : header()
    , goal_id()
    , goal()  {
    }
  UtteranceActionGoal_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , goal_id(_alloc)
    , goal(_alloc)  {
  (void)_alloc;
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::etts_msgs::UtteranceGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef boost::shared_ptr< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct UtteranceActionGoal_

typedef ::etts_msgs::UtteranceActionGoal_<std::allocator<void> > UtteranceActionGoal;

typedef boost::shared_ptr< ::etts_msgs::UtteranceActionGoal > UtteranceActionGoalPtr;
typedef boost::shared_ptr< ::etts_msgs::UtteranceActionGoal const> UtteranceActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "add8d67da9d5e62a59b0d0861fa3e729";
  }

  static const char* value(const ::etts_msgs::UtteranceActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xadd8d67da9d5e62aULL;
  static const uint64_t static_value2 = 0x59b0d0861fa3e729ULL;
};

template<class ContainerAllocator>
struct DataType< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "etts_msgs/UtteranceActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::etts_msgs::UtteranceActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::etts_msgs::UtteranceActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::etts_msgs::UtteranceGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
...
#endif // ETTS_MSGS_MESSAGE_UTTERANCEACTIONGOAL_H
