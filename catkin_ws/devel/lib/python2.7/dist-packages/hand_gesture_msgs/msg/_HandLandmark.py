...
"""autogenerated by genpy from hand_gesture_msgs/HandLandmark.msg. Do not edit."""
import codecs
import sys
...
class HandLandmark(genpy.Message):
  _md5sum = "af09f7d0e0a50b4df9d66c15e2f8a9e1"
  _type = "hand_gesture_msgs/HandLandmark"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This message represents a single hand landmark

int32 number  # from 0 to 20
string name  # see README.md for more info
float32[] coordinates  # coordinates x and y"""
  __slots__ = ['number','name','coordinates']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HandLandmark, self).__init__(*args, **kwds)
