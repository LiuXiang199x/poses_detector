...
"""autogenerated by genpy from tutorial_skill/TutorialActionResult.msg. Do not edit."""
import codecs
import sys
...
class TutorialActionResult(genpy.Message):
  _md5sum = "35e7bce0667b38e7100f5dabcf788180"
  _type = "tutorial_skill/TutorialActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tutorial_skill/TutorialResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TutorialActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tutorial_skill.msg.TutorialResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tutorial_skill.msg.TutorialResult()
