...
"""autogenerated by genpy from android_skill/AndroidActionResult.msg. Do not edit."""
import codecs
import sys
...
class AndroidActionResult(genpy.Message):
  _md5sum = "35e7bce0667b38e7100f5dabcf788180"
  _type = "android_skill/AndroidActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','android_skill/AndroidResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AndroidActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = android_skill.msg.AndroidResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = android_skill.msg.AndroidResult()
