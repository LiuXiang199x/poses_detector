...
"""autogenerated by genpy from etts_msgs/UtteranceAction.msg. Do not edit."""
import codecs
import sys
...
class UtteranceAction(genpy.Message):
  _md5sum = "7b6046c0630d7a8cf859a82ba5664983"
  _type = "etts_msgs/UtteranceAction"
...
"""
  ...
  _slot_types = ['etts_msgs/UtteranceActionGoal','etts_msgs/UtteranceActionResult','etts_msgs/UtteranceActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UtteranceAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = etts_msgs.msg.UtteranceActionGoal()
      if self.action_result is None:
        self.action_result = etts_msgs.msg.UtteranceActionResult()
      if self.action_feedback is None:
        self.action_feedback = etts_msgs.msg.UtteranceActionFeedback()
    else:
      self.action_goal = etts_msgs.msg.UtteranceActionGoal()
      self.action_result = etts_msgs.msg.UtteranceActionResult()
      self.action_feedback = etts_msgs.msg.UtteranceActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.utterance.header.seq, _x.action_goal.goal.utterance.header.stamp.secs, _x.action_goal.goal.utterance.header.stamp.nsecs))
      _x = self.action_goal.goal.utterance.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.utterance.text
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.utterance.language
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_hq3hf2h3I().pack(_x.action_goal.goal.utterance.primitive, _x.action_goal.goal.utterance.utteranceIdentifier, _x.action_goal.goal.utterance.emotion, _x.action_goal.goal.utterance.paralinguistic, _x.action_goal.goal.utterance.pitch, _x.action_goal.goal.utterance.prosody_rate, _x.action_goal.goal.utterance.volume, _x.action_goal.goal.utterance.priority, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_result.result.consequence, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.utteranceReceived
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.utterance.header.seq, _x.action_goal.goal.utterance.header.stamp.secs, _x.action_goal.goal.utterance.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.utterance.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.utterance.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.utterance.text = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.utterance.text = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.utterance.language = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.utterance.language = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.action_goal.goal.utterance.primitive, _x.action_goal.goal.utterance.utteranceIdentifier, _x.action_goal.goal.utterance.emotion, _x.action_goal.goal.utterance.paralinguistic, _x.action_goal.goal.utterance.pitch, _x.action_goal.goal.utterance.prosody_rate, _x.action_goal.goal.utterance.volume, _x.action_goal.goal.utterance.priority, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_hq3hf2h3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.consequence, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.utteranceReceived,) = _get_struct_B().unpack(str[start:end])
      self.action_feedback.feedback.utteranceReceived = bool(self.action_feedback.feedback.utteranceReceived)
      return self
...
def _get_struct_B():
    ...
    return _struct_B
_struct_hq3hf2h3I = None
def _get_struct_hq3hf2h3I():
    global _struct_hq3hf2h3I
    if _struct_hq3hf2h3I is None:
        _struct_hq3hf2h3I = struct.Struct("<hq3hf2h3I")
    return _struct_hq3hf2h3I
_struct_i3I = None
def _get_struct_i3I():
    global _struct_i3I
