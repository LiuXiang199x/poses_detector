...
"""autogenerated by genpy from etts_msgs/UtteranceGoal.msg. Do not edit."""
import codecs
import sys
...
class UtteranceGoal(genpy.Message):
  _md5sum = "c53758c81c169668f7aa3e3470102d6f"
  _type = "etts_msgs/UtteranceGoal"
...
"""
  __slots__ = ['utterance']
  _slot_types = ['etts_msgs/Utterance']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UtteranceGoal, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.utterance is None:
        self.utterance = etts_msgs.msg.Utterance()
    else:
      self.utterance = etts_msgs.msg.Utterance()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.utterance.header.seq, _x.utterance.header.stamp.secs, _x.utterance.header.stamp.nsecs))
      _x = self.utterance.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.utterance.text
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.utterance.language
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_hq3hf2h().pack(_x.utterance.primitive, _x.utterance.utteranceIdentifier, _x.utterance.emotion, _x.utterance.paralinguistic, _x.utterance.pitch, _x.utterance.prosody_rate, _x.utterance.volume, _x.utterance.priority))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.utterance.header.seq, _x.utterance.header.stamp.secs, _x.utterance.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.utterance.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.utterance.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.utterance.text = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.utterance.text = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.utterance.language = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.utterance.language = str[start:end]
      _x = self
      start = end
      end += 24
      (_x.utterance.primitive, _x.utterance.utteranceIdentifier, _x.utterance.emotion, _x.utterance.paralinguistic, _x.utterance.pitch, _x.utterance.prosody_rate, _x.utterance.volume, _x.utterance.priority,) = _get_struct_hq3hf2h().unpack(str[start:end])
      return self
