...
"""autogenerated by genpy from etts_msgs/UtteranceActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class UtteranceActionFeedback(genpy.Message):
  _md5sum = "49f5994682178148174e4bc5d52cfb50"
  _type = "etts_msgs/UtteranceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','etts_msgs/UtteranceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UtteranceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = etts_msgs.msg.UtteranceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = etts_msgs.msg.UtteranceFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.utteranceReceived
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.utteranceReceived,) = _get_struct_B().unpack(str[start:end])
      self.feedback.utteranceReceived = bool(self.feedback.utteranceReceived)
      return self
