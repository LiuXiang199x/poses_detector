...
"""autogenerated by genpy from etts_msgs/UtteranceActionResult.msg. Do not edit."""
import codecs
import sys
...
class UtteranceActionResult(genpy.Message):
  _md5sum = "9de1f3e562ccda2de9680a7f569ea05c"
  _type = "etts_msgs/UtteranceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','etts_msgs/UtteranceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UtteranceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = etts_msgs.msg.UtteranceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = etts_msgs.msg.UtteranceResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.consequence,) = _get_struct_i().unpack(str[start:end])
      return self
